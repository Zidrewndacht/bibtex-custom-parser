...
def regenerate_paper_main_set(cursor, paper_id, paper_data):
    ...
    """, (paper_id,))
        # =========================================================================
    # 8. Update main_certainty column
    # =========================================================================
    cursor.execute("UPDATE papers SET main_certainty = ? WHERE id = ?", (json.dumps(certainty_map), paper_id))
    
    # =========================================================================
    # 9. Update last_llm_* cache fields
    # =========================================================================
    cursor.execute("""
    UPDATE papers SET
        last_llm_features = features,
    ...
    # =========================================================================
    # 10. APPEND new averaged_llm entry to existing history (don't replace)
    # =========================================================================
    
    # Validate main_output has all required fields
    ...
    # Fetch existing llm_log and append
