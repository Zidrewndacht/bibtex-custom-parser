...
:: This is outdated. llama-fit-params should be used to optimize allocation instead nowadays.
...
llama-server.exe --port 8086 --main-gpu 0 --model "Qwen3-30B-A3B-Thinking-2507-UD-Q6_K_XL.gguf" --tensor-split 57,43 --n-gpu-layers 99 --temp 0.6 --ctx-size 163840 --flash-attn on --no-mmap -np 8 --alias "Qwen30b-Thinking-Q6" --jinja --reasoning-format deepseek
